import{dC as b,r as y,j as n,u as c,Q as te,$ as Ke,aW as C,aC as Ie,A as ve,a2 as ft,cs as _n,a as k,I as le,N as V,ap as Xe,ch as Nt,cS as Gn,cm as At,x as z,aN as Ct,a1 as zn,Y as jt,g as Un,du as Vn,by as Qn,Z as Br,ar as Kn,bW as Hn,U as Yn,E as Ee,O as He,y as Ye,ai as qn,dc as Jn,b3 as Zn,b4 as Xn,M as eo,aR as to,ag as ro,C as no,bx as Rr,bO as oo,cR as io,bJ as so,fO as ao}from"./index-3WWdADc-.js";import{T as Q,s as lo,g as $t,i as Nr}from"./TitleWithTooltip-5sfAnl-u.js";import{t as Wr,P as Lr,E as Ce,h as co}from"./Learn-iEpSD2rS.js";import{c as U}from"./zustandPrimitive-JpIny_aS.js";import{T as Me,u as kt,c as po}from"./getMarketplaceLinkForProduct-A-zEKrnh.js";import{f as M}from"./useAutoPlay-ceAGW3YF.js";import{e as uo,f as fo,K as mo,h as yo,j as ho,c as go,L as _r,k as xo}from"./SearchGraphModal-Qx3Zfqc8.js";import{C as Wt}from"./ChoiceBadge-RypXZaAe.js";import{L as vo}from"./LockedTitle-qegsyrMP.js";import{A as bo}from"./AddToMyListDropdown-j1WBFoh0.js";import{O as So,b as Gr,C as wo,P as Ao,M as Co,R as jo,L as $o,S as ko,a as Po}from"./StorageFeeCell-_Xhz7YT0.js";import{A as zr}from"./AboveTable-inLMfERi.js";import{g as Eo}from"./groupBy-U0u9Occh.js";import{b as Io,u as Ur}from"./dateRanges-u9-eXTpH.js";import{P as Mo}from"./OptimalData-it69sBiU.js";import{E as Pt}from"./ExtendedProductSummary-BHNYmxm-.js";import{P as Oo}from"./TagsMultiSelect-PKy7h-4F.js";import{A as Do}from"./react-alice-carousel-NHcyKvdv.js";import{u as To}from"./hooks-pZqYqtY6.js";import{u as Fo}from"./getListingAnalyzerKeywordsSection-jqe5lzYl.js";import{Q as Bo}from"./NewRadio-r0LBmnQI.js";function Vr(e){return Object.keys(e).map(t=>({key:t,value:e[t]}))}const Ro=({text:e,value:t,percents:r,color:o,isHighlighted:s,details:i})=>{const{t:l}=b(),p=o||s?"#1295ED":"#D9E0E8",[a,d]=y.useState(0);return y.useEffect(()=>{d(r)},[r]),n.jsxs(No,{children:[n.jsx(_o,{children:e?l(e):void 0}),n.jsxs(Wo,{children:[n.jsx("div",{id:"bar-container",children:n.jsx(Lo,{percents:a,barColor:p})}),i?n.jsx(Me,{content:i&&Object.keys(i).length>0?n.jsx(n.Fragment,{children:Vr(i).map(({key:f,value:m})=>n.jsxs("div",{children:[f," - ",typeof m=="number"?M({value:m}):m]},f))}):void 0,children:n.jsx(Lt,{children:t})}):n.jsx(Lt,{children:t})]})]})},No=c.div`
  display: flex;
  //flex-direction: row;
  align-items: center;
`,Wo=c.div`
...
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["static/html2pdf.es-LOwvzzI-.js","static/index-3WWdADc-.js"]
  }
  return indexes.map((i) => __vite__mapDeps.viteFileDeps[i])
}
//# sourceMappingURL=index-ePDqUNZh.js.map
