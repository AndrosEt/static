import{gg as m,r as t,j as r,a as c,b6 as u,gh as N,gi as M,gj as z,gk as B,gl as D,u as l,x as L,a1 as O,gm as Q}from"./index-tEWTe_cM.js";import{f as g,i as x,n as W}from"./useAutoPlay-8WOcIzK4.js";const X=(e,o)=>{const s=e.getState();return e.setState({_resettableLifeCycle:m()}),({children:i})=>(t.useEffect(()=>()=>{e.setState({...(o==null?void 0:o())||s,_resettableLifeCycle:m()},!0)},[]),r.jsx(r.Fragment,{children:i}))},Y=({rang:e})=>{const o=t.useMemo(()=>Number(e.toFixed(1)),[e]),s=t.useMemo(()=>A(o),[o]),i=t.useMemo(()=>e>=9.95?g({value:e>10?10:e,maximumFractionDigits:0,minimumFractionDigits:0}):g({value:e,maximumFractionDigits:1,minimumFractionDigits:1}),[e]);return r.jsxs(T,{children:[r.jsx(P,{$color:p[s],size:"xs",icon:G[s]}),r.jsx(q,{$color:p[s],children:i})]})},A=e=>e>=0&&e<=2?"weak":e>=2.1&&e<=4?"fair":e>4&&e<7?"good":e>=7&&e<9?"strong":"full",p={weak:c`
    color: ${u.tomato500};
  `,fair:c`
    color: ${u.orange500};
  `,good:c`
...
//# sourceMappingURL=NewRadio-DIL_Ez7J.js.map
