import{w as q,r as p,j as t,au as G,bH as J,u as o,a as r,I as d,y as u,Q as g,$ as U,Y as Z,K as _,bN as S,x as I}from"./index-VVIvRZBh.js";import{o as F}from"./useAutoPlay-JZxKBgmm.js";import{a8 as ee,a4 as te}from"./Learn-nfpDmxZa.js";const fe=({plans:e,features:l,featuresTitle:N,tableOnMobile:c,enableToggle:$,aboveCurrentPlan:f,bestLabel:W,onChangePlan:m})=>{const{t:b}=q(),y=F(S.laptop)||c,R=F(S.laptopBefore),X=e.map(s=>({children:s.label,value:s.id})),A=e.filter(s=>s.isBest===!0)[0],K=$&&R&&c,[a,v]=p.useState(A.id),[n,x]=p.useState(),[j,h]=p.useState(),Q=s=>{a&&v(null),x(s)};return p.useEffect(()=>{n&&(a&&v(null),m==null||m(n))},[n]),t.jsxs(se,{children:[K&&t.jsx($e,{children:t.jsx(me,{buttons:X,value:n??a,onChange:Q})}),t.jsxs(oe,{children:[t.jsx("thead",{children:t.jsxs(L,{children:[e.length!==0&&t.jsx(P,{$tableOnMobile:c??!1,children:t.jsx(le,{$tableOnMobile:c??!1,children:N??b("upsellModal.featuresTitle")})}),y&&e.map(s=>t.jsxs(P,{$highlight:s.id===n||s.id===a,$highlightHover:j===s.id,$tableOnMobile:c??!1,$enableToggle:$??!1,"data-toggle":s.id===n||s.id===a,onClick:()=>x(s.id),onMouseEnter:()=>h(s.id),onMouseLeave:()=>h(void 0),children:[s.isBest?t.jsxs(t.Fragment,{children:[t.jsx(ie,{children:t.jsx(ee,{type:"enabled",children:W??b("upsellModal.bestLabel")})}),t.jsx(z,{children:s.label})]}):t.jsxs(t.Fragment,{children:[t.jsx(re,{children:f!==null&&(f??b("upsellModal.currentPlan"))}),t.jsx(z,{children:s.label})]}),s.price?t.jsx(ne,{children:s.price}):null]},s.id))]})}),t.jsx("tbody",{children:l.map((s,C,Y)=>t.jsxs(L,{children:[t.jsxs(ae,{children:[t.jsx(de,{children:s.title}),s.subtitle&&t.jsx(ce,{children:s.subtitle})]}),y&&e.map(i=>{var w,B,M,T,k,H;return t.jsxs(D,{$highlight:i.id===n||i.id===a,$highlightHover:j===i.id,"data-highlight":i.id===n||i.id===a,$enableToggle:$??!1,"data-toggle":i.id===n||i.id===a,onClick:()=>x(i.id),onMouseEnter:()=>h(i.id),onMouseLeave:()=>h(void 0),$isLast:C===Y.length-1,children:[typeof((w=s.values)==null?void 0:w[i.id])=="string"&&t.jsx(E,{children:(B=s.values)==null?void 0:B[i.id]}),typeof((M=s.values)==null?void 0:M[i.id])=="boolean"&&((T=s.values)==null?void 0:T[i.id])===!0&&t.jsx(pe,{children:t.jsx(ge,{children:t.jsx(V,{icon:G})})}),typeof((k=s.values)==null?void 0:k[i.id])=="boolean"&&((H=s.values)==null?void 0:H[i.id])===!1&&t.jsx(E,{children:t.jsx(he,{icon:J})})]},i.id)})]},C))})]})]})},se=o.div``,O=r`
  ${d.laptopBefore} {
...
`,me=o(te)`
  ...
  max-width: 346px;
`;export{fe as O};
//# sourceMappingURL=OptimalDataVariant-bMjLlNCs.js.map
