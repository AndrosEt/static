...
`,rs=i.div`
  ${_e};
`,be=({open:e,onChange:t,renderTitle:n,renderContent:o})=>{const[r,c]=m.useState(!!e),l=m.useCallback(()=>{t?t():c(d=>!d)},[t]);return m.useEffect(()=>{c(!!e)},[e]),s.jsxs(as,{onClick:l,children:[s.jsxs(ds,{$status:r,children:[s.jsx(is,{children:n(r)}),s.jsx(ls,{children:s.jsx(cs,{$status:r,icon:qe})})]}),s.jsx(Es,{$status:r,children:s.jsx(dt,{isOpen:r,children:s.jsx(us,{children:o(r)})})})]})},as=i.div`
  cursor: pointer;
`,is=i.div`
  ${L};
...
`,qn=i.div`
  ...
  color: ${({theme:e})=>e.systemColors.grey600};
`,Xn=async(e,t)=>v({method:"GET",url:A(e,t),useSessionAccountId:!0}),me=Q((e,t)=>({...et(e,t,"productList",n=>{const o=w("productList");return Xn(o,n)})})),Kn=U(e=>{var t;return((t=e.productList.atom.content)==null?void 0:t.results)||[]},e=>{var t;return((t=e.productList.atom.payload)==null?void 0:t.marketplace)||""},(e,t)=>e.map(n=>({...n,label:n.asin,value:n.asin,imageSrc:n.imageUrl,title:n.title,href:W(t,n.asin)}))),Zn=e=>{const t=JSON.stringify(e),n=me(Kn),[o,r]=me(l=>[l.productList.atom.status==="loading",l.productList.action],se);m.useEffect(()=>{e.seller&&r(e)},[t]);const c=m.useCallback(l=>r({...e,term:l}),[r,e]);return[n,o,c]},Jn=()=>{const{t:e}=h(),{control:t}=F(),{seller:n,marketplace:o}=ve(),[r,c,l]=Zn({page:1,perPage:5,marketplace:o,seller:n});return s.jsxs(Qn,{children:[s.jsx(B,{label:e("customerEvents.noteModal.formFields.product.title")}),s.jsx(ne,{name:"products",control:t,render:d=>s.jsx(ht,{...d.field,options:r,onSearch:l,getBlocks:E=>[{text:E.asin}],loading:c,placeholder:e("customerEvents.noteModal.formFields.product.placeholder"),autocomplete:!0,appendTo:document.body})})]})},Qn=i.div``,eo=()=>{const{t:e}=h(),{control:t}=F(),n=bn(d=>d.status!=="loaded"),o=p(nn),[r,c]=m.useState(""),l=m.useMemo(()=>o.filter(d=>d.searchString.toLowerCase().includes(r.toLowerCase())),[o,r]);return s.jsxs(to,{children:[s.jsx(B,{label:e("customerEvents.noteModal.formFields.type.title")}),s.jsx(ne,{name:"eventTypes",control:t,render:d=>s.jsx(lt,{...d.field,appendTo:document.body,options:l,loading:n,onSearch:c,onCreate:E=>{var N,_;const u=Date.now(),x={id:u,title:E,name:E,searchString:E,value:u,label:E,color:Ge(o.length)};(_=(N=d.field).onChange)==null||_.call(N,[...d.field.value,x]),Gn.action({name:E,fakeId:u})},autocomplete:!0,placeholder:e("customerEvents.noteModal.formFields.type.placeholder")})})]})},to=i.div``,so=m.memo(()=>{const e=p(l=>l.properties.marketplace),t=j(l=>l.name),n=j(({noteModal:l})=>l),o=C(l=>l.noteModalController.close),r=tt({defaultValues:no(n,e)}),c=r.handleSubmit(({date:l,description:d,products:E,eventTypes:u})=>{const x=n==null?void 0:n.id,N={eventDate:xe(l||new Date,"yyyy-MM-dd"),asins:(E==null?void 0:E.map(({value:_})=>({asin:_,marketplace:e})))||[],types:(u==null?void 0:u.map(({value:_})=>_))||[],description:d};x?kn.action({noteId:x,componentName:t,params:N}):$n.action({componentName:t,params:N}),o()});return s.jsx(st,{...r,children:s.jsxs(oo,{onSubmit:c,id:"addEditNoteModalForm",children:[s.jsxs(ro,{children:[s.jsx(Pn,{}),s.jsx(eo,{}),s.jsx(Jn,{})]}),s.jsx(Un,{})]})})}),no=(e,t)=>{var n;return{date:e!=null&&e.eventDate?Bn(e.eventDate):void 0,description:(e==null?void 0:e.description)||"",products:((n=e==null?void 0:e.asins)==null?void 0:n.map(o=>({label:o.asin,value:o.asin,imageSrc:o.imageUrl,title:o.title,href:W(t,o.asin),asin:o.asin})))||[],eventTypes:(e==null?void 0:e.types.map(o=>({value:o.id,searchString:o.name,label:o.name})))||[]}},oo=i.form`
  display: flex;
  flex-direction: column;
  gap: ${({theme:e})=>e.spacing.sp16};
`,ro=i.div`
...
`,Ne=i.div`
  display: flex;
  gap: ${({theme:e})=>e.spacing.sp8};
`,Eo=({name:e,defaultSettings:t,children:n})=>(m.useEffect(()=>{if(!(p.getState().toolId!=="NOT_SET"))throw new Error("Customer events not initialized")},[]),s.jsxs(vt,{children:[s.jsx(uo,{name:e,defaultSettings:t}),n,s.jsx(ao,{}),s.jsx(Vs,{}),s.jsx(un,{}),s.jsx(hn,{})]})),uo=({name:e,defaultSettings:t})=>{const n=C(r=>r.nameController.set),o=C(r=>r.initSettings);return m.useEffect(()=>{n(e),o(t)},[]),null},bo=Object.assign(Eo,{AddNote:jt,Toggle:Vt,Settings:It});export{ss as A,bo as C,ae as E,we as N,Re as T,Ct as a,q as b,ge as c,In as d,Vn as e,bn as f,Vo as g,At as h,Io as i,ft as j,On as k,Tt as l,j as m,z as n,jo as o,C as p,_t as s,p as u};
//# sourceMappingURL=CustomerEventsComponent-YmM_p4Tw.js.map
