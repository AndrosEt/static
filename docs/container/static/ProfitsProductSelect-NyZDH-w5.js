...
`,z=u.div`
  margin-left: auto;
`,G=()=>{const e=d(a=>a.params),t=d(a=>a.term),[s,r]=d(a=>[a.productsRequest.action,a.productsRequest.abort]),c=R(s,500),l=i.useMemo(()=>e.marketplace?JSON.stringify({dependencies:e,term:t}):"",[e,t]);i.useEffect(()=>(c(),()=>{r()}),[r,c,l])},I=()=>(G(),null),V=e=>{const t=d(s=>s.setParams);i.useEffect(()=>t(e),[e,t])},W=({params:e})=>(V(e),null),_=e=>{const t=d(s=>s.updateOptions);i.useEffect(()=>e&&t(e),[e,t])},A=e=>(_({...e}),null),H=({updateOptions:e,params:t,onChange:s,value:r,className:c,...l})=>n.jsxs(y,{children:[n.jsx(A,{...e}),n.jsx(W,{params:t}),n.jsx(I,{}),n.jsx(q,{onChange:s,value:r,className:c,...l})]});export{H as P,w as g};
//# sourceMappingURL=ProfitsProductSelect-NyZDH-w5.js.map
