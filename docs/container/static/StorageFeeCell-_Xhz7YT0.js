import{a as m,u as i,K as z,bc as x,j as e,aW as R,N,x as k,bX as E,cu as M,cv as _,E as c,a2 as C,Q as j,aN as f,Y as I,r as L}from"./index-3WWdADc-.js";import{T as g}from"./getMarketplaceLinkForProduct-A-zEKrnh.js";import{f as d}from"./useAutoPlay-ceAGW3YF.js";import{R as Y}from"./middleware-lPGLX8nq.js";const J={1:m`
...
`,je=Object.assign(Q,{Wrapper:D,ChipsWrapper:A,Text:T}),y=({firstWidth:t,secondWidth:n,contentPosition:s="left"})=>e.jsxs(X,{contentPosition:s,children:[e.jsx(q,{$width:t}),n!=null&&e.jsx(G,{$width:n})]}),X=i.div`
  display: flex;
...
`,v=({onClick:t,disabled:n})=>e.jsx(N,{type:"button",buttonType:"icon",size:"50",icon:e.jsx(k,{icon:E}),onClick:t,disabled:n}),b=({value:t})=>t!=null&&t!==0?e.jsx(H,{rise:t>0,children:e.jsx(k,{icon:t>0?M:_})}):null,H=i.div`
  font-size: 14px;
  display: flex;
  align-items: center;
...
//# sourceMappingURL=StorageFeeCell-_Xhz7YT0.js.map
