...
`,Y=l.div`
  ...
  position: relative;
  top: 1px;
`,we=Object.assign(Ie,{Wrapper:z,Flag:V,Label:Y}),C=({text:t,link:r,rightIcon:e})=>s.jsxs(je,{href:r,target:"_blank",rel:"noreferrer",children:[s.jsx(J,{text:t}),e]}),J=({text:t,className:r})=>{const{isOverflown:e,checkOverflown:c}=H();return s.jsx(_,{content:t,disabled:e,children:s.jsx(Q,{onMouseEnter:c,className:r,children:t})})},Q=l.div`
  white-space: normal;
  overflow: hidden;
