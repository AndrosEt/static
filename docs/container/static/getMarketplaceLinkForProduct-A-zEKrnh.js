...
`,ze=s.div`
  ${z};
  text-align: center;
`,Ae=async(e,t)=>await se({url:le(re+"/api/v1/customers/subscription/data",{...e}),withCredentials:!0,signal:t}),Ge=(e,t)=>{const{platform:r,domain:n}=ne("store",e);return r==="AMAZON"?`https://${n}/dp/${t}`:`https://www.walmart.com/ip/name/${t}`};export{He as F,Ve as T,Ke as U,Ge as a,Ue as c,be as d,Ae as g,Qe as u};
//# sourceMappingURL=getMarketplaceLinkForProduct-A-zEKrnh.js.map
