import{j as t,cA as ve,aW as v,u as i,I as U,a2 as Z,r as s,E as we,bc as De,ai as Se,x as b,b6 as _,i7 as Ce,i8 as q,i9 as Ae,Q as Ve,a as Te}from"./index-tEWTe_cM.js";import{r as Fe}from"./server.browser-DFoAq_e7.js";import{A as Le}from"./ActionTitle-X3AI22EE.js";import{C as Pe,L as ke}from"./Chart-x9jYX_B3.js";import{C as Me}from"./highcharts-react.min-X0EFkdtl.js";import{f as ee}from"./useAutoPlay-8WOcIzK4.js";import{L as Ee}from"./LineGraphSkeleton-_OzzpDE4.js";import{e as Q}from"./Learn-ZI4QJ8Ms.js";const x=[38,65,75,61,52,87,75,13,62,79],Ne=({numberOfRow:e=5,numberOfColumns:r=9,legendWidth:n=187,legendCount:l=2})=>{const p=x==null?void 0:x.slice(0,r<=(x==null?void 0:x.length)&&r>=1?r:x==null?void 0:x.length);return t.jsxs(t.Fragment,{children:[l>0&&t.jsx(Oe,{children:t.jsx(ve,{builder:[{size:"medium",width:n,direction:"row",count:l}]})}),t.jsxs(We,{children:[[...new Array(e)].map((c,u)=>t.jsxs(ze,{children:[t.jsx(Ge,{}),t.jsx(Be,{})]},`${c} ${u}`)),t.jsx(He,{children:p==null?void 0:p.map((c,u)=>t.jsx(Ie,{$height:c,$index:u},`${c} ${u}`))})]}),t.jsx(Re,{children:t.jsx(v,{})})]})},We=i.div`
  display: flex;
  position: relative;
  flex-grow: 1;
...
//# sourceMappingURL=useChartLegend-7ulLO1yV.js.map
