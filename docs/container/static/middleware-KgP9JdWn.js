...
`,Lr=Object.assign(Ft,{Container:ge,Wrapper:ve}),_t=({data:{asin:e,marketplace:t,isMine:r,isNew:n,showCopyButton:s=!0},size:o,className:i})=>d.jsxs(ye,{className:i,children:[r&&d.jsx(Wt,{}),n&&d.jsx(Bt,{}),d.jsx(Ot,{marketplace:t}),d.jsx(Pt,{size:o,asin:e,showCopyButton:s})]}),Wt=g.memo(()=>{const{t:e}=O();return d.jsx(be,{type:"success",children:e("productSummary.myProduct")})}),Bt=g.memo(()=>{const{t:e}=O();return d.jsx(be,{type:"icon",children:e("productSummary.new")})}),Ot=g.memo(({marketplace:e})=>e!=null?d.jsx(Fe,{children:_e[e]}):null),Pt=g.memo(({size:e,asin:t,showCopyButton:r})=>d.jsxs(X,{"data-testid":"asin-label",children:[d.jsx("span",{children:t}),r&&d.jsx(Ut,{size:e,copyContent:t,contentLabel:"ASIN"})]})),X=y.div`
  display: flex;
  align-items: center;
  gap: ${e=>e.theme.spacing.sp4};
`,Yt=y.span``,Ut=g.memo(({size:e,copyContent:t,contentLabel:r})=>{const{t:n}=O();return d.jsx(We,{size:e!=="400"?"50":void 0,copyContent:t,beforeCopyContent:d.jsx(Be,{label:n("productSummary.copy",{label:r})}),afterCopyContent:d.jsx(Oe,{label:n("productSummary.copied",{label:r})})})}),ye=y(X)`
  ${Pe};
  gap: 8px;
`,be=y(Z)`
  ${Z.StatusTitle} {
