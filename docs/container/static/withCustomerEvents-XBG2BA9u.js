import{h as V}from"./highcharts-RNwAsTZN.js";import{w as x,j as a,u as m,$ as E,Q as w,r as h,bc as W,g as H,P as J,N as S,x as $,df as Q,cF as tt,aD as et,bV as st,A as nt,aE as rt,i7 as ot}from"./index-VVIvRZBh.js";import{E as b,g as D,h as at,i as it,j as lt,k as ct,u as _,c as pt,m as k,n as ut,o as gt,T as z,A as M,p as P,N as mt}from"./CustomerEventsComponent-JnkNYJka.js";import{c as y}from"./index-JL-77yQX.js";import{c as dt}from"./index-7v7JHEmS.js";import{o as I}from"./orderBy-yhmyNAlV.js";import{X as B,Y as O}from"./middleware-KgP9JdWn.js";import{ae as ft,as as ht,e as vt}from"./Learn-nfpDmxZa.js";import{a as xt}from"./getUpsellData--u-Ov2M_.js";import{P as Tt}from"./ProductChip-swqSSqla.js";function jt(t,e){var s;ft(1,arguments);var n=ht((s=e==null?void 0:e.additionalDigits)!==null&&s!==void 0?s:2);if(n!==2&&n!==1&&n!==0)throw new RangeError("additionalDigits must be 0, 1 or 2");if(!(typeof t=="string"||Object.prototype.toString.call(t)==="[object String]"))return new Date(NaN);var r=Dt(t),o;if(r.date){var i=Nt(r.date,n);o=At(i.restDateString,i.year)}if(!o||isNaN(o.getTime()))return new Date(NaN);var l=o.getTime(),c=0,g;if(r.time&&(c=Et(r.time),isNaN(c)))return new Date(NaN);if(r.timezone){if(g=St(r.timezone),isNaN(g))return new Date(NaN)}else{var p=new Date(l+c),u=new Date(0);return u.setFullYear(p.getUTCFullYear(),p.getUTCMonth(),p.getUTCDate()),u.setHours(p.getUTCHours(),p.getUTCMinutes(),p.getUTCSeconds(),p.getUTCMilliseconds()),u}return new Date(l+c+g)}var j={dateTimeDelimiter:/[T ]/,timeZoneDelimiter:/[Z ]/i,timezone:/([Z+-].*)$/},wt=/^-?(?:(\d{3})|(\d{2})(?:-?(\d{2}))?|W(\d{2})(?:-?(\d{1}))?|)$/,yt=/^(\d{2}(?:[.,]\d*)?)(?::?(\d{2}(?:[.,]\d*)?))?(?::?(\d{2}(?:[.,]\d*)?))?$/,Ct=/^([+-])(\d{2})(?::?(\d{2}))?$/;function Dt(t){var e={},s=t.split(j.dateTimeDelimiter),n;if(s.length>2)return e;if(/:/.test(s[0])?n=s[0]:(e.date=s[0],n=s[1],j.timeZoneDelimiter.test(e.date)&&(e.date=t.split(j.timeZoneDelimiter)[0],n=t.substr(e.date.length,t.length))),n){var r=j.timezone.exec(n);r?(e.time=n.replace(r[1],""),e.timezone=r[1]):e.time=n}return e}function Nt(t,e){var s=new RegExp("^(?:(\\d{4}|[+-]\\d{"+(4+e)+"})|(\\d{2}|[+-]\\d{"+(2+e)+"})$)"),n=t.match(s);if(!n)return{year:NaN,restDateString:""};var r=n[1]?parseInt(n[1]):null,o=n[2]?parseInt(n[2]):null;return{year:o===null?r:o*100,restDateString:t.slice((n[1]||n[2]).length)}}function At(t,e){if(e===null)return new Date(NaN);var s=t.match(wt);if(!s)return new Date(NaN);var n=!!s[4],r=T(s[1]),o=T(s[2])-1,i=T(s[3]),l=T(s[4]),c=T(s[5])-1;if(n)return Pt(e,l,c)?$t(e,l,c):new Date(NaN);var g=new Date(0);return!_t(e,o,i)||!kt(e,r)?new Date(NaN):(g.setUTCFullYear(e,o,Math.max(r,i)),g)}function T(t){return t?parseInt(t):1}function Et(t){var e=t.match(yt);if(!e)return NaN;var s=N(e[1]),n=N(e[2]),r=N(e[3]);return Mt(s,n,r)?s*B+n*O+r*1e3:NaN}function N(t){return t&&parseFloat(t.replace(",","."))||0}function St(t){if(t==="Z")return 0;var e=t.match(Ct);if(!e)return 0;var s=e[1]==="+"?-1:1,n=parseInt(e[2]),r=e[3]&&parseInt(e[3])||0;return It(n,r)?s*(n*B+r*O):NaN}function $t(t,e,s){var n=new Date(0);n.setUTCFullYear(t,0,4);var r=n.getUTCDay()||7,o=(e-1)*7+s+1-r;return n.setUTCDate(n.getUTCDate()+o),n}var bt=[31,null,31,30,31,30,31,31,30,31,30,31];function G(t){return t%400===0||t%4===0&&t%100!==0}function _t(t,e,s){return e>=0&&e<=11&&s>=1&&s<=(bt[e]||(G(t)?29:28))}function kt(t,e){return e>=1&&e<=(G(t)?366:365)}function Pt(t,e,s){return e>=1&&e<=53&&s>=0&&s<=6}function Mt(t,e,s){return t===24?e===0&&s===0:s>=0&&s<60&&e>=0&&e<60&&t>=0&&t<25}function It(t,e){return e>=0&&e<=59}const $e=function(t,e,s){const n=this.chart,r=n.plotLeft,o=n.plotTop,i=n.plotWidth,l=n.plotHeight,c=V.pick(this.options.distance,10),g=s.plotX,p=s.plotY;let u=g+r+(n.inverted?c:-t-c),f=p-e+o+e/2,d;return u<7&&(u=r+g+c),u+t>r+i&&(u-=u+t-(r+i),f=p-e+o-c,d=!0),f<o+5&&(f=o+5,d&&p>=f&&p<=f+e&&(f=p+o+c)),f+e>o+l&&(f=Math.max(o,o+l-e-c)),{x:u,y:f}},Y=({title:t,count:e,total:s,pointType:n})=>{const{t:r}=x();return a.jsxs(Ft,{children:[a.jsx(b,{pointType:n}),a.jsx(Ut,{children:t}),a.jsx(Rt,{children:r("customerEvents.tooltips.valueOfTotal",{value:e,total:s})})]})},Ft=m.div`
  display: flex;
  align-items: center;
...
`,ee=m.div`
  ...
  white-space: nowrap;
  color: ${({theme:t})=>t.systemColors.black};
`,F=({customerEvent:t,hideTooltip:e,renderTooltipInsights:s,renderInsightsEvents:n})=>{const{t:r}=x(),o=P(l=>l.eventsModalController.open),i=()=>{e==null||e(),o({...t,renderInsightsEvents:n})};return a.jsxs(se,{children:[a.jsx(ne,{children:vt(new Date(t.timestamp),t.meta.groupBy==="month"?"completeShort":"completeStandard")}),t.insights.length&&s?s(t.insights,!t.alertsAggregated.length&&!t.notes.length):null,t.notes.length?a.jsxs(a.Fragment,{children:[a.jsx(U,{}),a.jsx(Jt,{notes:t.notes})]}):null,t.alertsAggregated.length?a.jsxs(a.Fragment,{children:[a.jsx(U,{}),a.jsx(Ht,{alerts:t.alertsAggregated})]}):null,a.jsx(S,{buttonType:"text",onClick:i,children:r("customerEvents.tooltips.buttons.clickToViewAll")})]})},se=m.div`
  display: flex;
  flex-direction: column;
  gap: ${({theme:t})=>t.spacing.sp8};
`,ne=m.div`
...
`,ge=m(b)`
  cursor: pointer;
`,me={min:0,max:0,scale:0,left:0,top:0},C=nt(()=>({chartParams:{}})),q=rt(C,"chartParams"),X=y(t=>t.chartParams,(t,e)=>e,(t,e)=>t[e]??me)((t,e)=>e),de=({chartId:t,groupBy:e,asin:s,period:n,timezoneOffset:r,renderTooltipInsights:o,renderInsightsEvents:i})=>{const l=Number(r??0)*60*1e3,c=k(d=>d.settings),{data:g,status:p}=Gt({groupBy:e,asin:s,settings:c,period:n}),u=C(d=>X(d,t)),f=P(d=>d.eventsController.set);return fe(t),h.useEffect(()=>{f(g)},[g]),h.useMemo(()=>p==="loaded"?g.filter(d=>d.timestamp+l-u.min>0&&d.timestamp+l<u.max).map(d=>a.jsx(pe,{x:(d.timestamp+l-u.min)*u.scale+u.left,y:u.top,customerEvent:d,renderTooltipInsights:o,renderInsightsEvents:i},d.timestamp)):[],[p,g,l,u.min,u.max,u.scale,u.left,u.top,o,i])},fe=t=>{h.useEffect(()=>()=>{const e=C.getState().chartParams;q.set(ot(e,[t]))},[])},he=(t,e)=>{const s=X(C.getState(),t),n=e.target,r=n.xAxis[0],o=r.min??0,i=r.max??0,l=(r.width||1)/(i-o),c=r.left||0,g=n.plotTop+n.plotHeight;(s.min!==o||s.max!==i||s.scale!==l||s.left!==c||s.top!==g)&&q.patch({[t]:{min:o,scale:l,left:c,max:i,top:g}})},be=t=>({customerEventsProps:e,...s})=>{var i;const n=h.useId(),r=s,o=ve(r)?{...r,chart:R(n,r.chart)}:{...r,options:{...r.options,chart:R(n,(i=r.options)==null?void 0:i.chart)}};return a.jsxs(xe,{children:[a.jsx(t,{...o}),e.showPoints&&a.jsx(de,{chartId:n,...e})]})},ve=t=>"lines"in t&&"categories"in t,R=(t,e)=>({...e,events:{...e==null?void 0:e.events,redraw:function(s){var n,r;(r=(n=e==null?void 0:e.events)==null?void 0:n.redraw)==null||r.call(this,s),he(t,s)}}}),xe=m.div`
  position: relative;
`;export{Y as G,Gt as a,jt as p,$e as u,be as w};
//# sourceMappingURL=withCustomerEvents-XBG2BA9u.js.map
