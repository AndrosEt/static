import{d as B,b as Ae,j as o,cL as oe,a as Q,u as i,N as f,eo as so,f as v,g as P,P as Z,ad as re,e as T,r as h,c as L,m as ro,as as Se,w as k,aG as ao,aL as qt,ej as hn,b1 as gn,S as De,K as W,$ as ge,bi as co,bz as io,aC as z,x as xn,bp as lo,cj as uo,ck as mo,ak as po,aW as U,M as ie,O as yn,F as ho,A as xe,G as _e,a8 as Cn,ah as ze,bH as go,y as xo,aZ as yo,a2 as de,Q as Me,cS as fn,U as Co,aN as fo,E as Ke,I as ae,C as wo,a3 as Yt,cy as ko,bO as To,aM as wn,a5 as bo,bX as jo}from"./index-tEWTe_cM.js";import{T as se,g as be,E as vo,t as Ie,N as Qt,a0 as $o,e as en}from"./Learn-ZI4QJ8Ms.js";import{d as Ve}from"./use-onclickoutside.browser.esm-BisD5Fdu.js";import{N as he}from"./AddToMyListDropdown-lgmjWp6o.js";import{r as Ao,f as tn,L as So}from"./useAutoPlay-8WOcIzK4.js";import{r as ue,p as je,d as Mo,O as Po}from"./OptimalData-cuY_CBe9.js";import{u as Lo,a as Ue,U as Oo,g as Ro}from"./getUpsellData-siUtjfVt.js";import{P as Eo,E as kn}from"./ExtendedProductSummary-Rm3yeme_.js";import{l as Fo}from"./NewRadio-DIL_Ez7J.js";import{p as Tn,t as Ko,u as bn}from"./middleware-6VZ1FcKb.js";import{r as jn}from"./redirectToSubscribe-S6QlkQEz.js";function Io(...[e,t,n]){const s=B(`${e}Modal/Action`,...n!=null&&n.reaction?[n.reaction]:[]),c={data:t,isOpen:!1};return{atom:Ae(`${e}Modal/Atom`,c,d=>{var l;d(s,(m,p)=>p.type==="CLOSE"?{...m,isOpen:!1,data:n!=null&&n.doNotClearOnClose?m.data:t}:p.type==="OPEN"?{...m,isOpen:!0,...p.payload?{data:p.payload}:{data:t}}:p.type==="TOGGLE"?{...m,isOpen:!m.isOpen}:p.type==="SET_DATA"?{...m,data:p.payload}:m),(l=n==null?void 0:n.reducers)==null||l.call(n,d)}),open:(...d)=>s(t||t===null?{type:"OPEN",payload:d[0],meta:d[1]}:{type:"OPEN",payload:t,meta:d[0]}),close:(...d)=>s({type:"CLOSE",meta:d==null?void 0:d[0]}),action:s}}const ua=({buttonType:e,locked:t,disabled:n,icon:s,onLockedClick:c,onClick:r,...a})=>o.jsx(No,{icon:t?o.jsx(oe,{type:e,disabled:n}):s,onClick:t?c:r,disabled:n,buttonType:e,...a}),Go={primary:Q`
    &:hover,
    &:focus,
    &:focus-visible {
      ${oe.Wrapper} {
...
`,vn=({product:e,tooltipContent:t,marketplace:n,asin:s,tool:c,tooltipOptions:r,disableExtendedProductSummary:a,onChangeProductDetailsType:u,...d})=>o.jsx(so,{tooltipContent:t??o.jsx(Eo,{asin:s||"",marketplace:n,defaultImageSrc:e==null?void 0:e.imageSrc,tool:c,disableExtendedProductSummary:a,onChangeProductDetailsType:u}),tooltipOptions:{interactive:!0,maxWidth:605,placement:"top-start",...r},product:e,...d}),ma=vn,$n=async e=>v({url:P(`${ue}/api/site/track-event`,{}),method:"POST",params:e,useSessionAccountId:!0}),Ze=()=>({sendSegmentEvent:$n}),He=async e=>v({url:P(`${Z}/api/v1/keywordtracker/products`,{}),method:"GET",params:e,withCredentials:0}),An=({error:e,params:{notification:t}})=>{const n=re.getState().translation;n&&t.error(o.jsxs("div",{children:[o.jsx(se,{children:n.t("addToKeywordTracker.notification.error.title")}),o.jsx(be,{children:e||"Server error"})]}))},$e=Ve("ktGetProduct",async({marketplace:e},{getState:t})=>{const{page:n,count:s,search:c}=t(Ln);return He({marketplace:e,page:n,perPage:s,searchString:c})},{rejectedReaction:An}),nn={search:"",page:1,count:3,sortField:"id",sortDirection:"ASC"},Sn=B("ktAddSetSearch",({marketplace:e,notification:t},{dispatch:n})=>{n($e.actions.pending({marketplace:e,notification:t}))}),Mn=B("ktSetTableFilter",({marketplace:e,notification:t},{dispatch:n})=>{n($e.actions.pending({marketplace:e,notification:t}))}),Pn=B("resetTableFilter"),Ln=Ae("ktTableFilter",nn,e=>{e(Mn,(t,{filter:n})=>({...n,search:t.search})),e(Sn,(t,{search:n})=>({...t,page:1,search:n})),e(Pn,()=>nn)}),Je=B("setAddToKeyworTdrackerStep"),On=B("resetAddToKeyworTdrackerStep"),Bo=Ae("addToKeywordTrackerStep",0,e=>{e(Je,(t,n)=>n),e(On,()=>0)}),F=Io("addToKeywordTracker",{asin:"",marketplace:"",phrases:[],moduleId:"cerebro"},{reaction:({type:e},{dispatch:t})=>{e==="CLOSE"&&setTimeout(()=>{t(On())},100)}}),Wo=()=>{const e=T(Pn),t=T(F.close);return{onClose:h.useCallback(()=>{t(),setTimeout(e,0)},[t,e])}},Do={"cerebro-historical":"Cerebro Export to Keyword Tracker button clicked","cerebro-walmart":"Cerebro Export to Keyword Tracker button clicked",cerebro:"Cerebro Export to Keyword Tracker button clicked","keywordresearch-walmart":"Magnet Export to Keyword Tracker button clicked",keywordresearch:"Magnet Export to Keyword Tracker button clicked"},Rn={"cerebro-historical":"Cerebro Exported to Keyword Tracker","cerebro-walmart":"Cerebro Exported to Keyword Tracker",cerebro:"Cerebro Exported to Keyword Tracker","keywordresearch-walmart":"Magnet Exported to Keyword Tracker",keywordresearch:"Magnet Exported to Keyword Tracker"},_o={"cerebro-historical":"description","cerebro-walmart":"description",cerebro:"description",keywordresearch:"descriptionMagnet","keywordresearch-walmart":"descriptionMagnet","opportunity-finder":"descriptionCommon",blackbox:"descriptionCommon","blackbox-aba":"descriptionCommon","listing-builder":"descriptionCommon"},zo={"cerebro-historical":"Cerebro ASIN","cerebro-walmart":"Cerebro ASIN",cerebro:"Cerebro ASIN",keywordresearch:"Magnet","keywordresearch-walmart":"Magnet","opportunity-finder":"Elite Analytics",blackbox:"Black Box","blackbox-aba":"Black Box ABA","listing-builder":"Listing Builder"},Vo=async e=>v({url:P(`${Z}/keyword-tracker/validate-asin`,{}),params:e,method:"POST",withCredentials:0}),on={status:"init",content:null},En=B("validateAsinPending"),Fn=B("validateAsinFulfilled"),Kn=B("validateAsinRejected"),In=B("resetValidateAsin"),Gn=Ae("validateAsinAtom",on,e=>{e(En,t=>({...t,status:"loading",content:null,error:void 0})),e(Fn,(t,n)=>({...t,status:"loaded",content:n,error:void 0})),e(Kn,(t,n)=>({...t,status:"error",content:null,error:n})),e(In,()=>on)}),Nn=()=>{const e=T(En),t=T(Fn),n=T(Kn),{data:{marketplace:s}}=L(F.atom);return async c=>{try{const r={marketplace:s,asin:c,toolPlatform:s==="WALMART_US"?"walmart":"amazon"};e(r);const a=await Vo(r);if(t(a),!a.asin)throw new Error("Wrong asin");return!!a.asin}catch{return n("error"),!1}}},Uo=async e=>v({url:P(`${Z}/api/v1/keywordtracker/keywords`,{}),method:"POST",params:{...e,specialChars:!0},withCredentials:0}),Zo=async e=>v({url:P(`${Z}/api/v1/keywordtracker/product`,{}),method:"POST",params:{...e,copyTrackedHistory:!0,specialChars:!0},withCredentials:0}),Bn=Ve("ktAddProduct",async({data:e})=>{var s,c;const t=await He({searchString:e.asin,marketplace:e.marketplace,page:1,perPage:20}),n=(c=(s=t==null?void 0:t.results)==null?void 0:s.models[0])==null?void 0:c.id;return n!=null?Uo({productId:n,phrases:e.phrases,marketplace:e.marketplace,moduleId:e.moduleId}):Zo(e)},{fulfilledReaction:({params:{notification:e,onSuccess:t},result:n})=>{var c,r,a,u,d,l,m;const s=re.getState().translation;s&&((c=n.results)!=null&&c.saved&&(t==null||t((r=n.results)==null?void 0:r.saved),e.success(o.jsxs("div",{children:[o.jsx(se,{children:s.t("addToKeywordTracker.notification.success.title",{count:(a=n.results)==null?void 0:a.saved})}),o.jsx(be,{children:s.t("addToKeywordTracker.notification.success.text",{count:(u=n.results)==null?void 0:u.saved})})]}))),(d=n.results)!=null&&d.duplicates&&e.warning(o.jsxs("div",{children:[o.jsx(se,{children:s.t("addToKeywordTracker.notification.duplicates.title",{count:(l=n.results)==null?void 0:l.duplicates})}),o.jsx(be,{children:s.t("addToKeywordTracker.notification.duplicates.text",{count:(m=n.results)==null?void 0:m.duplicates})})]})))},rejectedReaction:({error:e,params:{notification:t},fetchError:n})=>{var c;const s=re.getState().translation;if(s){const r=(c=n==null?void 0:n.result)==null?void 0:c.errorCode;t.error(o.jsxs("div",{children:[o.jsx(se,{children:s.t("addToKeywordTracker.notification.error.title")}),o.jsx(be,{children:r?s.t(`addToKeywordTracker.notification.error.codes.${r}`):e||"Server error"})]}))}}}),Ho=ro("addToKTMarketplaceSelector",F.atom,e=>Se(e.data.marketplace==="WALMART_US"?"WM":"AM","store",e.data.marketplace)),Jo=({notification:e})=>{const{t}=k(),{data:{asin:n,title:s,imageSrc:c,phrases:r,moduleId:a,marketplace:u,onSuccess:d}}=L(F.atom),{content:l,status:m}=L(Gn),p=L(Ho),g=zo[a],{register:b,control:x,handleSubmit:I,setValue:K,watch:H}=ao({defaultValues:{asin:n,phrases:[],variations:!0}}),[G,y]=H(["asin","phrases"]);h.useEffect(()=>K("phrases",r),[r,K]);const w=T(F.close),{sendSegmentEvent:$}=Ze(),A=T(C=>{w();const j=Rn[a];return j&&$({eventName:j,eventProperties:{trackParentAndVariations:C.variations}}),Bn.actions.pending({data:{...C,marketplace:u,moduleId:a},notification:e,onSuccess:d})},[e,u,a]),S=I(A),M=Nn();return o.jsxs(o.Fragment,{children:[o.jsx(qo,{children:t("addToKeywordTracker.modal.title")}),o.jsx(Yo,{children:t(`addToKeywordTracker.modal.${_o[a]}`)}),o.jsxs(Qo,{onSubmit:S,children:[o.jsx(es,{children:o.jsx(qt,{name:"asin",control:x,render:({field:C})=>{const j=G?[G]:[],O=N=>{C.onChange(N.length>0?N[0].toLocaleUpperCase().replace("‎",""):void 0)};return o.jsx(Xo,{...C,value:j,onChange:O,inputProps:{placeholder:G?"":t("history.asinSearchPlaceholder")},getTooltipContent:()=>o.jsx(cs,{children:o.jsx(hn,{market:p.platform,product:{asin:(l==null?void 0:l.asin)||n,title:(l==null?void 0:l.title)||s,imageSrc:(l==null?void 0:l.imageUrl)||c},blocks:[{text:(l==null?void 0:l.asin)||n}]})}),size:"100",findSuggestionsMode:!0,clearOnError:!0,addTagsOnPressKeys:[","," "],onSeparate:sn,maxTags:1,validation:M,loading:m==="loading",error:m==="error"})}})}),o.jsx(ts,{children:o.jsx(qt,{name:"phrases",control:x,render:({field:C})=>o.jsx(he,{...C,inputProps:{placeholder:t("addToKeywordTracker.modal.placeholder")},size:"200",clearOnError:!0,addTagsOnPressKeys:[","," "],onSeparate:sn,maxTags:1e3,renderBeforeTags:o.jsxs(ns,{children:[o.jsx(ss,{}),o.jsx(os,{children:t("addToKeywordTracker.modal.inputPlaceholderNew",{toolText:g})})]})})})}),o.jsx(rs,{children:o.jsx(gn,{...b("variations"),children:t("addToKeywordTracker.modal.checkbox")})}),o.jsxs(as,{children:[o.jsx(f,{buttonType:"cancel",size:"200",onClick:w,type:"button",children:t("common.cancel")}),o.jsx(f,{buttonType:"primary",size:"200",disabled:y.length===0||!G,children:t("addToKeywordTracker.modal.startButton")})]})]})]})},sn=e=>e.split(/[\x09 ,;\n]+/).map(t=>t.trim()).filter(t=>!!t).slice(0,1),Xo=i(he)`
  width: 285px;
...
`,cs=i.div`
  max-width: 383px;
`,is=e=>{const t=new RegExp(" ","g");return e.replace(t," ")},ls=({notification:e})=>{const{t}=k();L(Ln,()=>null,[]);const{data:{marketplace:n}}=L(F.atom),{data:s,total:c,status:r}=L($e.atom,g=>{var b,x;return{data:((b=g.content)==null?void 0:b.results.models)||[],total:((x=g.content)==null?void 0:x.meta.totalCount)||0,status:g.status}},[]),a=ps({notification:e}),u=T(g=>Mn({filter:g,marketplace:n,notification:e}),[n,e]),d=T(Sn),l=T($e.actions.pending),p=co(g=>d({search:g.target.value,marketplace:n,notification:e}),800);return h.useEffect(()=>{n&&l({marketplace:n,notification:e})},[l,n,e]),o.jsxs(hs,{children:[o.jsxs(xs,{children:[o.jsxs(ys,{children:[t("addToKeywordTracker.productsModal.title"),o.jsx(Cs,{children:io[z("store",n).domain]})]}),o.jsx(ws,{onChange:p,rightElement:o.jsx(xn,{icon:lo})})]}),o.jsx(gs,{children:t("addToKeywordTracker.productsModal.description")}),o.jsx(fs,{children:o.jsx(vo,{name:"addToKTProducts",columns:a,data:s,total:c,status:r,behavior:us,onFilter:u,filter:ds,selected:ms})})]})},ds={haveInitial:!1},us={itemsPerPage:[3,10,50],noPagination:!0},ms={haveCheckbox:!1},ps=({notification:e})=>{const{t}=k(),{data:{phrases:n,marketplace:s,moduleId:c,onSuccess:r}}=L(F.atom),a=T(F.close),{sendSegmentEvent:u}=Ze(),d=T(l=>{a();const m=Rn[c];return m&&u({eventName:m,eventProperties:{trackParentAndVariations:!0}}),Bn.actions.pending({data:{asin:l,marketplace:s,phrases:n,variations:!0,moduleId:c},notification:e,onSuccess:r})},[e]);return h.useMemo(()=>[{field:"product",title:t("addToKeywordTracker.productsModal.table.product"),render:l=>{var x;const m=l.asin||"",p=(x=l.marketplace)==null?void 0:x.includes("WALMART"),g=t("copyButton.copy",{name:p?"Walmart Id":"ASIN"}),b=t("copyButton.copied",{name:p?"Walmart Id":"ASIN"});return o.jsx(rn,{onClick:()=>d(l.asin),children:o.jsx(hn,{product:{title:is(l.title||""),imageSrc:l.imageUrl||"",href:je(p?"WM":"AM",l.marketplace,l.asin)},market:p?"w":"a",marketplace:l.marketplace,blocks:[{text:`${m}`,copyContent:m,beforeCopyContent:o.jsx(uo,{label:g}),afterCopyContent:o.jsx(mo,{label:b})}],tooltipOptions:{appendTo:document.body}})})}},{field:"trackedKeywords",title:t("addToKeywordTracker.productsModal.table.trackedKeywords"),width:137,render:l=>o.jsx(rn,{onClick:()=>d(l.asin),children:l.keywords})}],[d,t])},hs=i.div``,gs=i.div`
  ${W};
...
`,ws=i(po)`
  max-width: 188px;
  margin-left: ${({theme:e})=>e.spacing.sp16};
`,ks=Ve("checkProductsRequest",async({marketplace:e})=>He({marketplace:e,page:1,perPage:1,searchString:""}),{fulfilledReaction:({result:e},{dispatch:t})=>{t(Je(e.meta.totalCount!==0?1:2))},rejectedReaction:An}),Ts=({notification:e})=>{const{isOpen:t,data:{marketplace:n}}=L(F.atom),s=T(()=>t?ks.actions.pending({marketplace:n,notification:e}):void 0,[n,e,t]);return h.useEffect(()=>{s()},[s]),o.jsxs(bs,{children:[o.jsxs(js,{children:[o.jsx(U,{$size:"small"}),o.jsx(U,{$size:"small"})]}),o.jsx(vs,{$size:"large"}),o.jsx($s,{}),o.jsxs(As,{children:[o.jsx(Re,{}),o.jsxs(Wn,{children:[o.jsx(Re,{}),o.jsx(Re,{})]})]})]})},bs=i.div``,js=i.div`
  ${W};
  display: flex;
...
`,Re=i(U)`
  min-height: 40px;
  width: 84px;
`,Ss=({step:e,notification:t})=>h.useMemo(()=>({0:o.jsx(Ts,{notification:t}),1:o.jsx(ls,{notification:t}),2:o.jsx(Jo,{notification:t})}),[t])[e],Ms=()=>{const{t:e}=k(),t=T(()=>Je(2),[]);return o.jsx(Ps,{children:o.jsx(f,{buttonType:"secondary",size:"200",onClick:t,children:e("addToKeywordTracker.productsModal.trackNewProduct")})})},Ps=i.div`
  display: flex;
  justify-content: flex-end;
`,Ls=({step:e})=>h.useMemo(()=>({1:o.jsx(Ms,{})}),[])[e],Os=({notification:e})=>{const t=L(Bo),{isOpen:n}=L(F.atom),s=Ss({step:t,notification:e}),c=Ls({step:t}),{onClose:r}=Wo();return o.jsx(Rs,{children:o.jsx(ie,{size:"100",zIndex:1e4,isOpen:n,onClose:r,footer:c,children:s})})},Rs=i.div`
  display: contents;

  ${ie.Footer} {
    border-top: 1px solid ${({theme:e})=>e.systemColors.grey200};
  }
`,pa=({data:e,moduleId:t,CustomButton:n,notification:s,onSuccess:c})=>{const{t:r}=k(),{sendSegmentEvent:a}=Ze();L(Gn);const{isOpen:u,data:{asin:d}}=L(F.atom),l=T(In),m=T(()=>{const g=Do[t];return g&&a({eventName:g,eventProperties:void 0}),F.open({...e,asin:e.asin?e.asin:"",title:e.title,imageSrc:e.imageSrc,onSuccess:c})},[e,t]),p=Nn();return h.useEffect(()=>{u&&d&&p(d),u||l()},[d,u]),o.jsxs(o.Fragment,{children:[n?o.jsx(n,{onClick:m}):o.jsx(f,{onClick:m,buttonType:"secondary",size:"100",children:r("addToKeywordTracker.button")}),o.jsx(Os,{notification:s})]})},ha=({item:e,isWalmart:t,asins:n,onClick:s,maxLength:c,marketType:r,tool:a})=>{var m;const u=h.useMemo(()=>n.indexOf(e.id)!==-1,[n,e.id]),d=h.useMemo(()=>u||c>n.length,[n.length,c,u]),l=Lo({data:{marketplace:r,asin:(e==null?void 0:e.id)||""}});return o.jsx(Es,{onClick:d?s:void 0,padding:"small",$active:u,$selectable:d,children:o.jsx(kn,{market:t?"WALMART":"AMAZON",product:{...e,asin:e.id},renderBlocks:l,marketplace:((m=Se(r!=null&&r.startsWith("amazon")?"AM":"WM","domain",r))==null?void 0:m.store)||"",tool:a||"listingAnalyzer"},e.id)})},Es=i(yn)`
  min-width: 0;
  ${({$active:e})=>e&&Q`
  ...
  ${({$selectable:e})=>e&&Q`
      cursor: pointer;
    `}
`;var me;(function(e){const t={cerebro:ue+"/api/cerebro/v1/amazon/competitors",walmart:ue+"/api/cerebro/v1/walmart/competitors-action",other:ue+"/api/v1/amazon/competitors",dashboard:Mo+"/api/v1/competitors"};e.getAmazon=async n=>{const{type:s,...c}=n,r=s==="cerebro"?t.cerebro:t.other,{data:a,...u}=await v({url:P(r,{}),method:"POST",params:c,useSessionAccountId:!0}),d=z("store",c.marketplace).domain;return{data:(a==null?void 0:a.map(l=>({href:je("AM",c.marketplace,l.productId),title:l.title,imageSrc:l.imageUrl,id:l.productId,marketType:d})))??[],...u}},e.getWalmart=async n=>{const{data:s,...c}=await v({url:P(t.walmart,{}),method:"POST",params:n,useSessionAccountId:!0}),r=z("store",n.marketplace).domain;return{data:(s==null?void 0:s.map(a=>({href:je("WM",n.marketplace,a.productId),title:a.title,imageSrc:a.imageUrl,id:a.productId,marketType:r})))??[],...c}},e.getDashboard=async n=>{const{results:s,...c}=await v({url:P(t.dashboard,{...n},{arrayFormat:"bracket"}),method:"GET",params:n,useSessionAccountId:!0});return{...c,data:s.map(r=>({href:je("AM",n.marketplace,r.asin),title:r.title,imageSrc:r.imageUrl,id:r.asin,asin:r.asin,marketType:z("store",r.marketplace).domain}))}}})(me||(me={}));var Ge;(function(e){const t=Z+"/api/v1/product/my-list";e.get=async n=>{try{const{data:s}=await v({url:P(t,{pageSize:100}),method:"GET",params:{marketplace:n.marketplace},useSessionAccountId:!0}),c=z("store",n.marketplace).domain;return{data:Object.values(s).map(r=>({href:Ue(n.marketplace,r.asin),title:r.title,imageSrc:r.imageUrl,id:r.asin,marketType:c})),errorCode:NaN,errors:{},message:""}}catch(s){const{message:c,responseStatus:r,result:a}=s;throw new ho(c,r,{data:[],errorCode:(a==null?void 0:a.code)||NaN,errors:{},message:(a==null?void 0:a.message)||""})}}})(Ge||(Ge={}));const Xe=xe(()=>({competitors:{data:[]},modal:null})),Fs=_e(Xe,"competitors",async e=>{const t=z("store",e.marketplace).platform;if(e.type==="my-list")return await Ge.get({marketplace:e.marketplace});if(e.type==="dashboard")return e.seller!=null?await me.getDashboard({marketplace:e.marketplace,seller:e.seller,asin:e.productId}):null;if(t==="AMAZON")return await me.getAmazon({marketplace:e.marketplace,productId:e.productId,type:e.type});if(t==="WALMART")return await me.getWalmart({marketplace:e.marketplace,productId:e.productId})},{initialStatus:"loading",rejected:({fetchError:e})=>{var n,s;const t=(n=re.getState().translation)==null?void 0:n.t;if(t){const c=t(`errorCodes.${(s=e==null?void 0:e.result)==null?void 0:s.errorCode}`)||t(`errors.common.${e==null?void 0:e.responseStatus}`)||t("errorCodes.unknown");Ie.error(c)}}}),ga=Cn(Xe,"modal",{reaction:({type:e,payload:t})=>{e==="OPEN"&&t&&Fs.action({marketplace:t.marketplace,productId:t.productId,type:t.type})}}),xa=Fo(Xe),qe=xe()(Tn((e,t)=>({top10RankedProductsForKeyword:!0,asinDetails:!0}),{name:"UIExtraTableSettings"})),Ks=ze(qe,"top10RankedProductsForKeyword"),Is=ze(qe,"asinDetails"),ya=({showTop10RankedProductsForKeyword:e,showAsinDetails:t})=>{const{t:n}=k(),{top10RankedProductsForKeyword:s,asinDetails:c}=qe();return o.jsxs(o.Fragment,{children:[o.jsxs(Gs,{children:[n("extraTableSettings.title"),o.jsx(go,{content:n("extraTableSettings.titleTooltip"),colorType:"light"})]}),o.jsxs(Ns,{children:[e&&o.jsx(an,{checked:s,onChange:r=>Ks.set(r.target.checked),children:n("extraTableSettings.top10RankedProductsForKeyword")}),t&&o.jsx(an,{checked:c,onChange:r=>Is.set(r.target.checked),children:n("extraTableSettings.asinDetails")})]})]})},Gs=i.p`
  ${xo};
...
`,an=i(gn)`
  align-items: center;
`,Bs=async e=>{const t=await v({method:"GET",url:P(Ko,{...e,advancedView:1}),withCredentials:0,useSessionAccountId:!0});return Object.keys(t.data).map(n=>({...t.data[n],asin:n}))},Ws="UI_TOP10_PRODUCTS_FOR_KEYWORD",ee=xe()(Tn((e,t)=>({advancedView:!0,productData:{}}),{name:Ws,partialize:e=>({advancedView:e.advancedView})})),Pe=yo(ee,"productData",async({key:e,params:t})=>{const n=t.phraseId;return Bs({...n&&n>0?{phraseId:n.toString()}:{keyword:e},marketplaceId:z("store",t.marketplace).id})},{rejected:({fetchError:e})=>{if((e==null?void 0:e.responseStatus)===429){const t=re.getState().translation;Ie.message(o.jsx(se,{children:t==null?void 0:t.t("keywordWithTop10Products.error")}))}},fulfilled:({result:e})=>{if((e==null?void 0:e.length)===0){const t=re.getState().translation;Ie.message(o.jsx(se,{children:t==null?void 0:t.t("keywordWithTop10Products.noProducts")}))}}}),Ds=ze(ee,"advancedView"),Dn=e=>{var s;const t=(s=Pe(c=>c[e]))==null?void 0:s.status,n=ee(c=>c.productData[e]);return h.useMemo(()=>t==="error"||t==="loaded"&&(n==null?void 0:n.length)===0,[n,t])},_s=({keyword:e,marketplace:t,tool:n,disableExtendedProductSummary:s,onChangeProductDetailsType:c})=>{const r=ee(d=>d.productData[e]),a=Pe(d=>{var l;return(l=d[e])==null?void 0:l.status}),{platform:u}=z("store",t);return o.jsx(Hs,{children:a==="loading"?o.jsx(Vs,{}):r==null?void 0:r.map((d,l)=>o.jsxs(_n,{children:[o.jsxs(zn,{children:[l+1,"."]}),o.jsx(kn,{imageSize:"50",imageTooltipOptions:{appendTo:"parent"},market:u,marketplace:t,tool:n,titleLineClamp:1,product:{title:d.title,asin:d.asin,imageSrc:d.imageUrl,href:Ue(t,d.asin)},renderBlocks:o.jsx(zs,{product:d,marketplace:t}),disableExtendedProductSummary:s,onChangeProductDetailsType:c})]},l))})},zs=({product:e,marketplace:t})=>{const{t:n}=k(),{currency:s}=z("store",t);return o.jsxs(Us,{children:[o.jsx(ke,{children:(e==null?void 0:e.price)>=0?de({amount:s==="JPY"?e==null?void 0:e.price:(e==null?void 0:e.price)/100,currency:s}):"-"}),o.jsx(ke,{children:n("keywordWithTop10Products.variations",{value:tn({value:e.variationCount})})}),o.jsx(ke,{children:n("keywordWithTop10Products.reviews",{value:tn({value:e.reviewCount})})}),o.jsx(ke,{children:n("keywordWithTop10Products.rating",{value:e.reviewsRating})})]})},Vs=()=>o.jsx(o.Fragment,{children:new Array(10).fill(void 0).map((e,t)=>o.jsxs(_n,{children:[o.jsxs(zn,{children:[t+1,"."]}),o.jsxs(Zs,{children:[o.jsx(Ee,{$size:"large",$width:42,$height:42}),o.jsx(Ee,{$size:"medium",$width:340,$height:18}),o.jsx(Ee,{$size:"small",$width:260,$height:16})]})]},t))}),Us=i.div`
  ${Me};
  display: flex;
...
`,Js=({keyword:e,marketplace:t,tool:n,disableExtendedProductSummary:s,onChangeProductDetailsType:c})=>{const r=ee(fn(u=>u.productData[e])),a=Pe(u=>{var d;return(d=u[e])==null?void 0:d.status});return o.jsx(qs,{children:a==="loading"?o.jsx(Xs,{}):r==null?void 0:r.map((u,d)=>o.jsxs(Un,{children:[o.jsxs(Vn,{children:[d+1,"."]}),o.jsx(vn,{size:"400",product:{imageSrc:u.imageUrl,href:Ue(t,u.asin)},marketplace:t,asin:u.asin,tool:n,tooltipOptions:{appendTo:"parent"},disableExtendedProductSummary:s,onChangeProductDetailsType:c})]},d))})},Xs=()=>o.jsx(o.Fragment,{children:new Array(10).fill(void 0).map((e,t)=>o.jsxs(Un,{children:[o.jsxs(Vn,{children:[t+1,"."]}),o.jsx(Ys,{$size:"large",$width:76,$height:96})]},t))}),qs=i.div`
  display: grid;
...
`,Ys=i(U)`
  height: ${({$height:e})=>e}px;
`,Qs=({keyword:e,phraseId:t,marketplace:n,tool:s,...c})=>{const{t:r}=k(),{sendSegmentEvent:a}=bn({}),[u]=ee(l=>[l.advancedView]),d=Dn(e);return h.useEffect(()=>{Pe.action([{key:e,params:{marketplace:n,phraseId:t}}]),a({name:"Keyword Hover Product Viewed",properties:{tool:s,view:u?"advanced":"simple",display:"show"}}).then()},[e,n,t,a,s]),o.jsx(o.Fragment,{children:d?o.jsx(Zn,{keyword:e,tool:s,disableSegmentEvent:!0}):o.jsxs(tr,{$advancedView:u,children:[o.jsxs(nr,{children:[o.jsx(er,{children:r("keywordWithTop10Products.title",{keyword:e})}),o.jsx(or,{checked:u,onChange:l=>Ds.set(l.target.checked),children:r("keywordWithTop10Products.advancedView")})]}),u?o.jsx(_s,{keyword:e,marketplace:n,tool:s,...c}):o.jsx(Js,{tool:s,keyword:e,marketplace:n,...c})]})})},Zn=({keyword:e,tool:t,disableSegmentEvent:n})=>{const{sendSegmentEvent:s}=bn({}),[c]=ee(r=>[r.advancedView]);return h.useEffect(()=>{n||s({name:"Keyword Hover Product Viewed",properties:{tool:t,view:c?"advanced":"simple",display:"hide"}}).then()},[n,e,s,t]),e},er=i.div`
  ${Co}
`,tr=i.div`
...
`,Ca=({keywordNode:e,disableExtendedTooltip:t,keyword:n,tool:s,simpleTooltip:c,disableTooltip:r,...a})=>{const{isOverflown:u,checkOverflown:d}=fo(),l=Dn(n);return o.jsx(o.Fragment,{children:t||c?o.jsx(Ke,{content:o.jsx(Zn,{keyword:n,tool:s,disableSegmentEvent:c}),disabled:u,children:o.jsx(cn,{onMouseEnter:d,children:e||n})}):o.jsx(Ke,{content:o.jsx(Qs,{keyword:n,tool:s,...a}),interactive:!0,colorType:l?"dark":"light",maxWidth:964,disabled:r,children:o.jsx(cn,{children:e||n})})})},cn=i.div`
  overflow: hidden;
  text-overflow: ellipsis;
  color: ${({theme:e})=>e.systemColors.black};
`,Hn=({coupon:e,label:t,data:n})=>o.jsxs(sr,{children:[e&&o.jsx(rr,{dangerouslySetInnerHTML:{__html:e}}),t&&o.jsx(cr,{$small:!!e,$data:n,children:t}),(n==null?void 0:n.proration)&&o.jsx(ar,{children:n==null?void 0:n.proration})]}),sr=i.div`
...
`,jr=({isNewUi:e,coupon:t,data:n,modalProps:s,footerJustifyContent:c,onAccept:r,onDecline:a})=>{const u=t?n==null?void 0:n.footer.labelWithCoupon:n==null?void 0:n.footer.label;return o.jsx(ie,{...s,size:"100",title:n==null?void 0:n.title,titleAlign:"center",footer:o.jsx(o.Fragment,{children:n&&o.jsxs(Ar,{$footerJustifyContent:c,$data:n,children:[o.jsx(f,{buttonType:n.proration?"secondary":"text",size:"200",onClick:a,children:n.footer.declineButton}),o.jsx(f,{"data-testid":"acceptButton",buttonType:"primary",size:"200",onClick:()=>r==null?void 0:r({}),children:n.footer.acceptButton})]})}),children:n&&o.jsxs(o.Fragment,{children:[n.subtitle&&o.jsx($r,{noFeatures:n.plans.length===0,children:n.subtitle}),o.jsx(vr,{children:o.jsx(Oo,{isNewUi:e,plans:n.plans,features:n.features,featuresTitle:n.featuresTitle})}),o.jsx(Hn,{label:u,coupon:t,data:n})]})})},vr=i.div`
...
`,Qr=i.div`
  ...
  display: flex;
  justify-content: flex-end;
`;export{Be as A,vn as E,ha as G,Ca as K,ua as L,ma as N,ln as O,fa as U,jr as a,We as b,pa as c,Io as d,ya as e,qe as f,Ks as g,Is as h,Gr as i,wa as j,ka as k,Ze as l,Pr as m,Xe as n,Fs as o,ga as p,xa as q,Zo as r,dn as s,is as t,pe as u};
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["static/SearchVolumeGraph-9MkYPFB0.js","static/index-tEWTe_cM.js","static/AddToMyListDropdown-lgmjWp6o.js","static/NewRadio-DIL_Ez7J.js","static/useAutoPlay-8WOcIzK4.js","static/middleware-6VZ1FcKb.js","static/Learn-ZI4QJ8Ms.js","static/use-latest.esm-33sMI_t6.js","static/use-onclickoutside.browser.esm-BisD5Fdu.js","static/MarketplaceSingleSelect-J9Q4NESj.js","static/ChartExport-1KlP8bAy.js","static/LineGraphSkeleton-_OzzpDE4.js"]
  }
  return indexes.map((i) => __vite__mapDeps.viteFileDeps[i])
}
//# sourceMappingURL=SearchGraphModal-8Lh4F5Sv.js.map
