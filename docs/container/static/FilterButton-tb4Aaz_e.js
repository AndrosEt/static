import{r as a,j as r,x as n,bZ as b,u as e,N as d,a as u,a1 as y}from"./index-3WWdADc-.js";const $=a.forwardRef(({changesCount:s,icon:o,...l},c)=>r.jsx(i,{...l,ref:c,buttonType:"tertiary",$changes:s>0,icon:s>0?r.jsx(t,{children:s}):o??r.jsx(n,{icon:b})})),i=e(d)`
  ${({$changes:s})=>s&&u`
...
`;export{$ as F};
//# sourceMappingURL=FilterButton-tb4Aaz_e.js.map
