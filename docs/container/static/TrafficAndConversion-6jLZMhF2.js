import{j as s,E as q,x as Q,cn as pe,u as p,f as Ce,g as ue,P as je,w as S,ad as ge,A as fe,G as me,b6 as A,N as Z,r as b,aM as De,I as m,Q as he,Z as $e,y as ke,$ as Pe,a as _,K as Oe,cs as Re,aW as J,bv as W,bE as Ve}from"./index-3WWdADc-.js";import{g as Be}from"./groupBy-U0u9Occh.js";import{g as ze,c as Le,b as Ie,d as Me,h as Ne,s as te,D as _e}from"./TagsMultiSelect-PKy7h-4F.js";import{g as Fe}from"./index-4X1FVNh6.js";import{a as z,s as F,e as X,b as G,c as Ue}from"./middleware-lPGLX8nq.js";import{s as We}from"./index-IyiqQa2_.js";import{h as B,t as Ge,e as L}from"./Learn-iEpSD2rS.js";import{f as I,o as se}from"./useAutoPlay-ceAGW3YF.js";import{C as He}from"./Collapse-tP42S7bB.js";import{A as Ke}from"./AirTable-8H-5frrn.js";import{r as Ye}from"./server.browser-XcXyx2ie.js";import{a as qe}from"./AddToMyListDropdown-j1WBFoh0.js";import{C as Qe}from"./ChartExport-xG8FR1Rx.js";import{L as Ze}from"./LineGraphSkeleton-eFZ_jC28.js";const ae=({content:e,className:t})=>s.jsx(q,{content:e,children:s.jsx("div",{className:t,children:s.jsx(Q,{icon:pe})})}),H=(e,t,a)=>{const n=Be(e,o=>{const i=new Date(o[0]),r=ze(i);return t==="week"?`${r}-${Fe(i)}`:t==="month"?`${r}-${Le(i)}`:t==="year"?r:""});return Object.entries(n).reduce((o,[i,r])=>{const d=r[0][0],u=t==="week"?z(We(d),1):t==="month"?z(Ie(d),1):t==="year"?z(Me(d),1):new Date(d);return(!a||Ne(u,a))&&o.push([u.getTime(),r.reduce((y,c)=>y+c[1],0)/r.length]),o},[])},M=p.div`
  width: 8px;
  height: 8px;
  border-radius: 4px;
  margin: 4px;
...
//# sourceMappingURL=TrafficAndConversion-6jLZMhF2.js.map
