import{j as s,E as q,x as Q,cn as pe,u as p,f as Ce,g as ue,P as je,w as S,ad as ge,A as fe,G as me,b6 as A,N as Z,r as b,aM as De,I as m,Q as he,Z as $e,y as ke,$ as Pe,a as _,K as Oe,cs as Re,aW as J,bv as W,bE as Ve}from"./index-tEWTe_cM.js";import{g as Be}from"./groupBy-7ZtSo7lr.js";import{g as ze,c as Le,b as Ie,d as Me,h as Ne,s as te,D as _e}from"./WidthLimitedTagsValue-Gph_9FLc.js";import{g as Fe}from"./index-Ca0BkoYE.js";import{a as z,s as F,e as X,b as G,c as Ue}from"./middleware-6VZ1FcKb.js";import{s as We}from"./index-ECFt0NIj.js";import{h as B,t as Ge,e as L}from"./Learn-ZI4QJ8Ms.js";import{f as I,o as se}from"./useAutoPlay-8WOcIzK4.js";import{C as He}from"./Collapse--SIf9dr3.js";import{A as Ke}from"./AirTable-Gyhy-mr-.js";import{r as Ye}from"./server.browser-DFoAq_e7.js";import{a as qe}from"./AddToMyListDropdown-lgmjWp6o.js";import{C as Qe}from"./ChartExport-1KlP8bAy.js";import{L as Ze}from"./LineGraphSkeleton-_OzzpDE4.js";const ae=({content:e,className:t})=>s.jsx(q,{content:e,children:s.jsx("div",{className:t,children:s.jsx(Q,{icon:pe})})}),H=(e,t,a)=>{const n=Be(e,o=>{const i=new Date(o[0]),r=ze(i);return t==="week"?`${r}-${Fe(i)}`:t==="month"?`${r}-${Le(i)}`:t==="year"?r:""});return Object.entries(n).reduce((o,[i,r])=>{const d=r[0][0],u=t==="week"?z(We(d),1):t==="month"?z(Ie(d),1):t==="year"?z(Me(d),1):new Date(d);return(!a||Ne(u,a))&&o.push([u.getTime(),r.reduce((y,c)=>y+c[1],0)/r.length]),o},[])},M=p.div`
  width: 8px;
  height: 8px;
  border-radius: 4px;
  margin: 4px;
...
//# sourceMappingURL=TrafficAndConversion-PykU-_2y.js.map
